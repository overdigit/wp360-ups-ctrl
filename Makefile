...
install:
	...
	install -d $(DESTDIR)$(prefix)/src/wp360_pmuc-2/
	...
	install module/wp360_pmuc.c $(DESTDIR)$(prefix)/src/wp360_pmuc-2/
	install module/wp360_pmuc.h $(DESTDIR)$(prefix)/src/wp360_pmuc-2/
	install module/Makefile $(DESTDIR)$(prefix)/src/wp360_pmuc-2/
